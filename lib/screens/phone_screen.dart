...
class _PhoneScreenState extends State<PhoneScreen> {
  ...
  void phoneSignIn() {
    context.read<FirebaseAuthMethods>().phoneSignIn(context, phoneController.text.trim());
    //FirebaseAuthMethods(FirebaseAuth.instance).phoneSignIn(context, phoneController.text.trim());
  }
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          CustomButton(onTap: phoneSignIn, text: 'OK'),
        ],
      ),
    );
  }
